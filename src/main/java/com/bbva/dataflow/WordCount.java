...
import static com.bbva.dataflow.ExampleUtils.*;
...
public class WordCount {
    ...
    static void runWordCount(DummyOptions options) {
        ...
        lines.apply("WriteCounts", TextIO.write().to(options.getOutput()));
    ...
    public static void main(String[] args) {
        DummyOptions options =
                PipelineOptionsFactory.fromArgs(args).withValidation().as(DummyOptions.class);
